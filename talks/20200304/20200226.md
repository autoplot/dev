...
* Autoplot scripting is Jython, a Python implementation for Java applications, plus additional codes which make an environment similar to IDL or Matlab.
...
* Jython used, with additional methods (like findgen or ones) automatically imported.
