...
* searches result in hits which are a particular snapshot--need to switch back to the "master"
* The IDE looks nice, but it also wants to save to particular snapshots.
